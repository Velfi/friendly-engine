...
pub const prop_instance_place_schema = "{\"type\":\"object\",\"properties\":{\"asset\":{\"type\":\"string\",\"description\":\"Prop asset id from the prop catalog\"},\"point_x\":{\"type\":\"number\"},\"point_y\":{\"type\":\"number\",\"description\":\"Vertical offset above sampled terrain, in meters\"},\"point_z\":{\"type\":\"number\"},\"yaw\":{\"type\":\"number\",\"description\":\"Y-axis rotation in radians\"},\"scale_world\":{\"type\":\"number\",\"minimum\":0.001}},\"required\":[\"asset\",\"point_x\",\"point_z\"],\"additionalProperties\":false}";
...
const prop_instance_place_fields = &.{
...
pub const entries = [_]Entry{
    ...
    .{ .command_name = "prop.instance-place", .mcp_tool_name = "prop_instance_place", .title = "Place Prop Instance", .description = "Place an existing prop catalog asset at a world-space point in the open editor scene.", .tier = .stable, .owner = .prop, .argument_policy = .fields, .input_schema = prop_instance_place_schema, .fields = prop_instance_place_fields },
    ...
    .{ .command_name = "prop.render-mode", .mcp_tool_name = "prop_render_mode", .title = "Set Prop Render Mode", .description = "Set Prop Edit render mode. Pass object as wireframe, solid, material_preview, lod_debug, or rendered. Legacy aliases wire, unlit, lod, lit, and full are accepted.", .tier = .stable, .owner = .prop, .argument_policy = .fields, .input_schema = object_schema, .fields = object_fields },
